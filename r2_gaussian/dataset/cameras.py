...
class Camera(nn.Module):
    def __init__(
        ...
        self.image_width = splat_width if splat_width is not None else self.original_image.shape[2]
        self.image_height = splat_height if splat_height is not None else self.original_image.shape[1]
